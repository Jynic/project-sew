    ...
    <div id='container'>
        <div id='content-edit'>
            <table cellspacing=5 id='table-edit'>
                ...
                <tr>
                    <td><label class='lbl'>Lulusan</label></td>
                    <td><label class='lbl'>Username</label></td>
                </tr>
                <tr>
                    <td>
                        <select id='cbkelas-edit' class='input' id='cbkelas'>
                            <option value="<?php echo $lulusan ;?>" ><?php echo $lulusan ;?></option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" value='<?php echo $matpel ;?>' placeholder='Masukan Password' class='input' id='txtpassword'></td>
                </tr>
                <tr>
